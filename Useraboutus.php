...
body{ background-image:url("http://www.intersystems.com/assets/cache-bg.jpg");
...
<div class="section">
<img src="http://actionaidsacco.org/kenya/wp-content/uploads/2014/12/vision-mission.png" height="200px" width="1000px">
<h1 style="text-indent: 50px">VISION : </h1>
<h3 style="text-indent: 50px;">Vision to provide  a greater experience to explore the world by north to south and east &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspto west around the globe with an affortable cost</h3>
<h1 style="text-indent: 50px">MISSION : </h1>
<h3 style="text-indent: 50px;">  1 . World Explore tourism and travels provides a wide range of discounts such as &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"The longer the tour ,The greater the discounts "</h3>
<h3 style="text-indent: 50px;">  2 . World Explore tourism and travels provides fare cost of accomdation by &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspassociated hotels</h3>
</div>
